...
public class CommonRestController {
	 ...
	 */
	@PostMapping("/create")  
	public ResponseEntity<Map<String, Object>> create( @RequestBody HashMap param) throws Exception {
		ResponseEntity<Map<String, Object>> entity = null;
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("success", false);

		HashMap paramMap = new HashMap(param);
		int record = masterService.dataCreate("mapper.admin.CommonMapper", "category", paramMap);
		
		if(record > 0) {
			map.put("success", true);
			map.put("msg", "카테고리 등록이완료되었습니다.");
		}
	 ...
	 */
	@PostMapping("/update")  
	public ResponseEntity<Map<String, Object>> update( @RequestBody HashMap param) throws Exception {
		ResponseEntity<Map<String, Object>> entity = null;
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("success", false);

		HashMap paramMap = new HashMap(param);
		int record = masterService.dataCreate("mapper.admin.CommonMapper", "update", paramMap);
	...
	@GetMapping("/detail")
	public ResponseEntity<Map<String, Object>> detail(@RequestParam(value = "seq" , required = false) String seq) throws Exception {
		ResponseEntity<Map<String, Object>> entity = null;		Map<String, Object> map = new HashMap<String, Object>();

		map.put("success", false);
		HashMap<String, Object> param = null;
		param =(HashMap)masterService.dataRead("mapper.admin.CommonMapper", "detail", seq);
		if(param !=null) map.put("success", true);
		 map.put("data", param);
