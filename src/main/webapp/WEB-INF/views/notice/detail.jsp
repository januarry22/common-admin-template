            ...
            <div class="card">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label class="login-label" for="exampleInputUsername1">작성자</label>
                            <input type="text" class="form-control board-input" value="${detail.title}" disabled>
                        </div>
                        <div class="form-group">
                            <label class="login-label" for="exampleInputUsername1">제목</label>
                            <input type="text" class="form-control board-input" id="exampleInputUsername1" name="title" value="${detail.title}" disabled>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="card-body button-body">
                        <button type="button" class="btn btn-primary btn-fw update-btn" data-seq="${detail.notice_seq}">수정 </button>
