...
<c:set var="page_seq" value="content_seq"/>
...
$(function(){
	...
	/* 		"gif_seq" : gif_seq.val(), */
 	  	...
 	  	ajaxCallPost("/supervise/admin/v1/content/create", param, function(res){
				if(res.success){
  ...
  <!-- partial -->
       <div class="content-wrapper">
            <div class="page-header">
               <span class="page-title"> 수면 청각 컨텐츠 관리 </span>
                      ...
                      <table id="order-listing" class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>${item.content_play }</td> 
                            <td>${item.content_goods }</td>
                            <td>
                              <button class="btn btn-info detail-btn" data-toggle="modal" data-target="#content_update" data-seq="${item.content_seq}">수정</button>
                              <button class="btn btn-danger remove-btn" data-seq="${item.content_seq}">삭제</button>
                            </td>
                          </tr>
                          </c:forEach>
                        </tbody>
      ...
      <div class="modal fade" id="content_create" tabindex="-1" role="dialog" aria-labelledby="#content_create" aria-hidden="true">
                    ...
                    <form class="forms-sample">
                      <div class="form-group">    
                       <label class="login-label" for="title">유형</label>
                       </div>
                      <div class="form-group">    
                  ...
                  <!--     <div class="form-group">
                        <label class="login-label" for="exampleInputPassword1"> gif 파일 </label>
                         <input type="hidden" name="gif_url"/>
                         <input type="file" class="dropify gif_fun" id="img_val"/>
                      </div> -->
                         <div class="form-group">
