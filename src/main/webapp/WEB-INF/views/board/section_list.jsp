...
<div class="row">
    <div class="card">
        <div class="card-body">
            <button  class="btn btn-success text-white create-modal" data-toggle="modal" data-target="#create-section"><i class="mdi mdi-note-plus-outline"></i>신규 게시판 추가</button>
        </div>
        <div class="card-body">
                ...
                <table id="zero_config"
                    ...
                    <c:forEach var="item" items="${list }">
                        <tr>
                            ...
                            <td>${item.title }</td>
                            <c:set var="seq" value="${item.board_section_seq}"/>
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel-3">신규 게시판 생성</h5>
            ...
            <div class="modal-body">
                <form class="forms-sample">
                    <label class="login-label">회원</label>
                    ...
                    <label class="login-label">게시판명</label>
                    <div class="form-group" style="display: flex;">
                        <input style="flex: 3;margin-right: 5px;" id="title" class="form-control" name="title" placeholder="게시판명을 입력해주세요.">
                    </div>
...
<div class="modal" id="update-section" style="display: none;">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">게시판 정보 수정</h5>
